...
**Las extensiones compatibles generalmente incluyen:** =====- `.gz` / `.bz2` (gzip / bzip2): Compatible y funciona de inmediato.
...
Puntos clave: =====- `select`: Vector de nombres/posiciones de columnas a conservar (descarta las demás).
...
Escenarios admitidos: =====- Comillas sin escape dentro de campos entre comillas===== p. ej., `"Esta "comilla" no es válida, pero fread funciona de todos modos"` — admitido siempre que el recuento de columnas permanezca constante:
...
Requisitos y limitaciones: =====- Las reglas de escape y los recuentos de columnas deben ser consistentes en todo el archivo.=====
