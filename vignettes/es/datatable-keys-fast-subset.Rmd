...
* primero, introducir el concepto de `clave` en *data.table*, y establezca y use claves para realizar *búsquedas binarias rápidas* basadas en subconjuntos en `i`,
...
En cambio, en *data.tables*, establecemos y usamos `keys`. Piensa en una `key` como si fuera un conjunto de **nombres de fila supercargados**.
...
#### -- Sobre el resultado obtenido anteriormente, utilice el encadenamiento (chaining) para ordenar la columna en orden decreciente.
